...
public class SettingsActivity extends PreferenceActivity {
    ...
    private void setupSimplePreferencesScreen() {
        ...
        bindPreferenceSummaryToValue(findPreference(getResources().getString(R.string.key_display_mode_in_call)));
        findPreference(getResources().getString(R.string.key_show_notification))
                .setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                    @Override
                    public boolean onPreferenceChange(Preference preference, Object o) {
                        Boolean newValue = (Boolean) o;
                        startService(new Intent(SettingsActivity.this, ScreenShiftService.class)
                                .setAction(ACTION_SET_NOTIFICATION)
                                .putExtra(EXTRA_SET_NOTIFICATION, newValue));
                        return true;
                    }
                });
    }
