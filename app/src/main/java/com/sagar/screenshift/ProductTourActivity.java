    ...
    public class CrossfadePageTransformer implements ViewPager.PageTransformer {
        ...
        public void transformPage(View page, float position) {
            ...
            if( position == 0.0f ) {
                ...
                // parallax effect
                if(object2 != null){
                    ViewHelper.setTranslationX(object2,pageWidth*1.2f * position);
                }

                if(object4 != null){
                    ViewHelper.setTranslationX(object4,pageWidth/1.2f * position);
                }
                if(object5 != null){
                    ViewHelper.setTranslationX(object5,pageWidth/1.6f * position);
                }
                if(object6 != null){
                    ViewHelper.setTranslationX(object6,pageWidth/2f * position);
                }
                if(object7 != null){
                    ViewHelper.setTranslationX(object7,pageWidth*1.4f * position);
                }
                ...
                if(object3 != null){
                    ViewHelper.setTranslationX(object3,pageWidth/1.2f * position);
                }
            }
        }
    }
